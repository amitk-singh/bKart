            ...
            <div className="page-layout-container">
                ...
                <div className="section-1">
                    <form className="sign-up">
                        ...
                        <p>Having trouble in Sign up <span className="txt-highlight"><a href="#url"> Get help</a></span><span><a class="txt-highlight txt-float-right" href="./login.html">Login</a></span></p>
                    </form>
                </div>
